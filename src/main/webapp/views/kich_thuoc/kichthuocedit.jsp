...
<body>
    <h4>Update</h4>
    <form action="/kich-thuoc/kichthuocupdate/${data.id}" method="POST">
        <div class="mt-2">
            <label for="" class="form-label">Mã: </label>
            <input type="text" class="form-control" placeholder="Mã" name="ma" value="${data.ma}">
        </div>
        <div class="mt-2">
            <label for="" class="form-label">Tên: </label>
            <input type="text" class="form-control" placeholder="Tên" name="ten" value="${data.ten}">
        </div>
        <div class="mt-2">
