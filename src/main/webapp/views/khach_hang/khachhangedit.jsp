...
<body>
    <h4>Update</h4>
    <form action="/khach-hang/khachhangupdate/${data.id}" method="POST">
        <div clas="mt-2">
            <label for="" class="form-label">Mã: </label>
            <input type="text" placeholder="Mã" class="form-control" name="ma" value="${data.ma}">
        </div>
        <div class="mt-2">
            <label for="" class="form-label">Tên: </label>
            <input type="text" placeholder="Tên" class="form-control" name="ten" value="${data.ten}">
        </div>
        <div class="mt-2">
            <label for="" class="form-label">Số điện thoại: </label>
            <input type="text" placeholder="Số điện thoại" class="form-control" name="soDienThoai" value="${data.soDienThoai}">
        </div>
        <div class="mt-2">
