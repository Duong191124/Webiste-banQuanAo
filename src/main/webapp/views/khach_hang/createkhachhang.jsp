...
<div>
    <form action="/khach-hang/khachhangstore" method="post">
        <div class="mt-2">
        ...
        <div class="mt-2">
            ...
            <input type="text" name="soDienThoai" class="form-control" placeholder="Số điện thoại" value="${data.soDienThoai}">
            <c:if test="${not empty error['soDienThoai']}">
                <small style="color: red">${error['soDienThoai']}</small>
            </c:if>
        </div>
        <div class="mt-2">
        ...
        <div class="mt-2 d-flex justify-content-center">
            <a href="/index" class="btn btn-primary w-25 me-2">Back</a>
